        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <img src="/logo.png" alt="Clinic Logo" className="h-16 w-25 " />
            </div>
            <p className="text-slate-300 text-sm leading-relaxed">
              Your trusted partner in healthcare. Book appointments with top
              doctors and manage your health journey with ease.
            </p>
            <div className="flex space-x-4">
              {/* Fixed: Added proper <a> tags with accessibility attributes */}
              <a
              ...
              <a
                href="https://twitter.com/healthcare"
                aria-label="Twitter"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-slate-800 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors"
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="text-slate-300 hover:text-blue-400 transition-colors text-sm flex items-center"
                >
                  <span className="mr-2">→</span> Find Doctors
                </Link>
              </li>
              <li>
                <Link
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center text-slate-300 text-sm">
                <svg
                  className="w-5 h-5 mr-2 text-blue-400 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
